...
CPPU_CFLAGS = $(CPPUTEST_CFLAGS) $(CPPUTEST_ADDITIONAL_CFLAGS)
CPPU_CPPFLAGS = $(CPPUTEST_CPPFLAGS) $(CPPUTEST_ADDITIONAL_CPPFLAGS)
CPPU_CXXFLAGS = $(CPPUTEST_CXXFLAGS) $(CPPUTEST_ADDITIONAL_CXXFLAGS)
CPPU_LDFLAGS = $(CPPUTEST_LDFLAGS) $(CPPUTEST_ADDITIONAL_LDFLAGS)
...
flags:
	@echo
	@echo "OS ${UNAME_OS}"
	@echo "Compile C and C++ source with CPPU_CPPFLAGS:"
	@$(call debug_print_list,$(CPPU_CPPFLAGS))
	@echo "Compile C++ source with CPPU_CXXFLAGS:"
	@$(call debug_print_list,$(CPPU_CXXFLAGS))
	@echo "Compile C source with CPPU_CFLAGS:"
	@$(call debug_print_list,$(CPPU_CFLAGS))
	@echo "Link with CPPU_LDFLAGS:"
	@$(call debug_print_list,$(CPPU_LDFLAGS))
...
print:
	@echo deps $(TEST_DEPS)
	@echo objs_dir $(CPPUTEST_OBJS_DIR)
...
$(CPPUTEST_OBJS_DIR)/test/%.cc.o: test/%.cc
...
$(CPPUTEST_OBJS_DIR)/test/%.cpp.o: test/%.cpp
	@echo compiling $(notdir $<)
	$(SILENCE)mkdir -p $(dir $@)
	$(SILENCE)$(CXX) $(CXXFLAGS) $(CPPU_CXXFLAGS) $(DEP_FLAGS) -c $(OUTPUT_OPTION) $<
